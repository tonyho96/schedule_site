...
@section('content')
    ...
    <div class="container-fluid" style="background-color: #ffffff; padding: 15px; border: 1px solid #ddd;">
        <form action="{{ route('save-groomer') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="tab-content" style="border: 1px solid #ddd; border-top: 0px; padding: 0px 15px;">
                        ...
                        <div id="details" class="tab-pane fade in active">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="mobile-tel" name="mobile_phone"/>
                                </div>
                            </div>
